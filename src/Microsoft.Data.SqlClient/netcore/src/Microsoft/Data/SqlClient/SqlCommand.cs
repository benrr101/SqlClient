...
namespace Microsoft.Data.SqlClient
{
    ...
    public sealed partial class SqlCommand : DbCommand, ICloneable
    {
        ...
        private SqlCommand(SqlCommand from) : this()
        {
            ...
            {
                parameters.Add(parameter is ICloneable cloneable ? cloneable.Clone() : parameter);
            }
        }
            ...
            using (TryEventScope.Create("SqlCommand.Prepare | API | Object Id {0}", ObjectID))
            {
                ...
                try
                {
                    ...
                    if (this.IsPrepared && !this.IsDirty
                        ...
                        || (System.Data.CommandType.Text == this.CommandType && GetParameterCount(_parameters) == 0))
                    {
                        if (Statistics != null)
                        {
        ...
        private SqlDataReader RunExecuteReaderTds(CommandBehavior cmdBehavior, RunBehavior runBehavior, bool returnStream, bool isAsync, int timeout, out Task task, bool asyncWrite, bool inRetry, SqlDataReader ds = null, bool describeParameterEncryptionRequest = false)
        {
            ...
            try
            {
                ...
                else if (this.CommandType == CommandType.Text && GetParameterCount(_parameters) == 0)
                {
